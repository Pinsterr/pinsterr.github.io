  ...
  data: () => ({
    ...
    items: [
      ...
      },
      {
        ...
        html:
          'ME: "Woooow!"<br><i>... Of course got slapped later!</i>',
      ...
      },
      {
        ...
        `,
        image:
          'img/timeline/an7.mahblog.com.png',
        imageHeight: 200,
        icon: 'mdi-web',
      },
      {
      ...
      },
      {
        ...
        `,
        image:
          'img/timeline/street-mobsters.jpg',
        iconImage:
          'img/timeline/street-mobsters-icon.png',
      },
      {
        detailed: true,
        year: '2012',
      ...
      },
      {
        ...
        image:
          'img/timeline/bytegate.ir.jpg',
        iconImage:
          'img/timeline/bytegate.ir-icon.png',
      },
      {
        detailed: true,
        year: '2014-15',
        transparent: true,
        title:
          'Created a Captcha Solving Farm',
      ...
      },
      {
        ...
        `,
        image:
          'img/timeline/wifi-shield.png',
        iconImage:
          'img/timeline/wifi-shield-icon.png',
      },
      {
        year: '2016',
        ...
        iconImage:
          'img/timeline/bobet.ir-icon.png',
      },
      {
        year: '2017',
        transparent: true,
      ...
      },
      {
        ...
        iconImage:
          'img/timeline/delix.ir-icon.png',
      },
      {
        detailed: true,
        transparent: true,
      ...
      },
      {
        year: '2019',
        title:
          'Open Sourced Telegram Web Bridge',
        html: `
          <p>
        ...
        `,
        image:
          'img/timeline/telegram-web-bridge.png',
        icon: 'mdi-github-circle',
      },
      {
        year: '2019',
        title:
          'Open Sourced USB Keystroke Injector',
        html: `
          <p>
        ...
        `,
        image:
          'img/timeline/usb-keystroke-injector.png',
        icon: 'mdi-github-circle',
      },
      {
        year: '2019',
      ...
      },
      {
        ...
        `,
        image:
          'img/timeline/vue-modern-resume.png',
        icon: 'mdi-github-circle',
      },
      {
        year: '2019',
        title:
          'Published Vue Registrar Package',
        html: `
          <p>
        ...
        `,
        image:
          'img/timeline/vue-registrar-demo.png',
        iconImage:
          'img/timeline/vue-registrar-logo.png',
      },
      {
        year: 'So far ...',
        title:
          'Written 340+ Unique Articles!',
